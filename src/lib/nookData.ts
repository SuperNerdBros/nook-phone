...
export const projectsData: ProjectItem[] = [
  ...
  // 	},
  {
    ...
    appIcon: "critter",
    description:
      "A clean and simple tracking and logging tool for all bugs, fish, and sea creatures.",
    languages: ["en"],
  ...
  },
  {
    ...
    bg: "bg-[#1b9be0]",
    description:
      "Dodo Airlines Flight Hub. Schedule, track, and manage flights for your island! Dodo Air is always ready for take-off!",
    languages: ["en"],
    site: "/dodo-air/",
    information: ["gameplay"],
    tools: ["utilities"]
  ...
  },
  {
    name: "Miles",
    appIcon: "miles",
    description: "Achievement visualizer for your island adventures",
    languages: ["en"],
    logo: "",
    logoStyle: "",
  ...
  },
  {
    ...
    description: "Guide for beginners starting their island adventure.",
    languages: ["en"],
    logo: "bg_logo.png",
    logoStyle: "banner",
  ...
  },
  {
    name: "FAQ",
    appIcon: "chat",
    description: "Answers to frequently asked questions about island life.",
    languages: ["en"],
    logo: "faq_logo.png",
    logoStyle: "banner",
  ...
  },
  {
    name: "Guide",
    appIcon: "passport",
    description: "A free multi-purpose guide and cataloging app with Catalog Scanner integration.",
  ...
  },
  {
    name: "Pattern Tool",
    appIcon: "camera_alt",
    description: "Create and convert custom pattern designs",
    languages: ["en"],
  ...
  },
  {
    name: "Wiki",
    appIcon: "clock",
    description: "Umfangreiches Community-Wiki und Leitfaden.",
    languages: ["de"],
  ...
  },
  {
    name: "World",
    appIcon: "contacts",
    description: "Blogs, guides, and news about island life",
    languages: ["en"],
  ...
  },
  {
    name: "Animal Guide",
    appIcon: "dating",
    description: "Guidebook with comprehensive info on collectibles, villagers, and more",
    languages: ["en"],
  ...
  // 	},
  {
    name: "Nookazon",
    appIcon: "weather",
    description: "Buy and sell custom items, furniture, and materials with other players",
    languages: ["en", "es", "de", "fr", "it", "jp", "ko", "nl", "ru", "zh"],
    logo: "nookazon.svg",
    logoStyle: "banner",
  ...
  },
  {
    name: "NookFriends",
    appIcon: "shopping",
    description: "The friendliest player and island community!",
    languages: ["en"],
  ...
  },
  {
    ...
    appIcon: "diy",
    description:
      "The independent encyclopedia and wiki, covering all items, villagers, and events, along with an API service",
    languages: ["en"],
    logo: "nookipedia.png",
    logoStyle: "banner",
  ...
  },
  {
    ...
    appIcon: "best_friend",
    description:
      "A full catalogue and checklist containing all items, furniture, and clothing in the game and more",
    languages: ["en", "es", "fr", "de", "it", "nl", "ru", "zh", "jp", "ko"],
  ...
  // 	},
  {
    name: "Yue's Island Guides",
    description:
      "Visual reference guides for flowers, rock setups, and island layouts, available in multiple languages",
